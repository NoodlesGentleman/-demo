...
<script src="${STATIC_URL}/js/sysRole/sysRoleNew.js"></script>
    ...
    <aside class="aside-md bg-white b-r">
        <section class="vbox">
            <header class="b-b header">
                <p class="h4">添加角色</p>
                <p class="h4" style="float: right;"><a href="javascript:;" class="list" id="returnPage" rel="sysRoleList">&lt&lt角色管理</a></p>
            </header>
            
            <section class="scrollable wrapper w-f">
                <form class="form-horizontal" id="edit_form" action="${STORE_URL}/sysRole/save" method="post"  enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <textarea rows = "5"  class="form-control" id="role_desc" name="role_desc"  maxlength="100" onkeydown='countChar("role_desc","counter");' onkeyup='countChar("role_desc","counter");'>${sysUserRolesModel.role_desc}</textarea>
                       	还可以输入<span id="counter">100</span>字<br/>
                       	</div>
                    </div>
                    <div class="line line-dashed line-lg pull-in"></div>
