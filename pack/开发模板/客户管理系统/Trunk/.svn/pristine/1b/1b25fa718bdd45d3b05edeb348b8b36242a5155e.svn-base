...
<!-- 网页内容的js和css样式加载-->
<script src="${STATIC_URL}/js/sysUser/sysUserList.js"></script>

<section class="vbox">
    <header class="header bg-white b-b clearfix">
        <div class="row m-t-sm">
            <div class="col-sm-1 m-b-xs">
                <a href="${STORE_URL}/sysUser/newView" class="btn btn-sm btn-default load-content"><i class="fa fa-plus"></i> 添加</a>
            </div>
            <div class="col-sm-2 m-b-xs">
                <div class="input-group">
                    <input type="text" style = "width:130px" name="userName" class="input-sm form-control" placeholder="用户名称搜索" />
                </div>
            </div>
            <div class="col-sm-1 m-b-xs">
    ...
    <section class="scrollable wrapper">
        <section class="panel panel-default">
            <div class="table-responsive">
                <table class="table table-striped m-b-none datagrid" id="sysUser_listing">
                    <thead>
                    </thead>
                    <tfoot>
                        <tr>
