...
<script src="${STATIC_URL}/js/rights/permissionassign.info.js" type="text/javascript"></script>
            ...
            <section class="scrollable w-f">
                <ul class="nav nav-pills nav-stacked no-radius">
                    ...
                    <li class="b-b m-t-none-reset <c:if test="${navigationId == v.navigationId }">active</c:if>">
                        <a href="${STORE_URL}/sysRoleNav/infoViewNew?navigationId=${v.navigationId}&roleId=${sysRole.role_id}" class="load-content">
    ...
    <aside>
        <section class="vbox">
            <header class="header bg-white b-b clearfix">
                <p>查看角色《${sysRole.role_name}》的权限</p>
            </header>
                 <table>
                    <tbody>
                    <tr>
