...
<!-- 网页内容的js和css样式加载-->
<script src="${STATIC_URL}/back/redbaglog/js/list.js"></script>
<section class="vbox">
	...
	<header class="header bg-white b-b clearfix" style="height:100px;">
		<div class="row m-t-sm">
			<label for="" class="control-label" style="float:left;margin-top: 8px;">发放金额：</label>
            <div class="col-sm-2 minw200">
        		<input type="text" class="form-control" id="total_amount" name="" value=""/>
            </div>
            <label for="" class="control-label" style="float:left;margin-top: 8px;">红包订单号：</label>
            <div class="col-sm-2 minw200">
	            <input type="text" class="form-control" id="mch_billno" name="" value=""/>
            </div>
            <label for="" class="control-label" style="float:left;margin-top: 8px;">发放时间：</label>
            <div class="col-sm-2 minw200">
        		<input type="text" id="sent_time" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})"
					class="form-control" data-date-format="yyyy-mm-dd" value=""/>
            </div>
        </div>
		<div class="row m-t-sm">
