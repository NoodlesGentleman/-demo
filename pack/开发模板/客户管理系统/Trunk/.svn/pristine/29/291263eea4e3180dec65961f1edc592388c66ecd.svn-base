...
<script src="${STATIC_URL}/js/rights/permission.index.js" type="text/javascript"></script>
            ...
            <header class="header bg-white b-b clearfix">
                <div class="row m-t-sm">
                    <div class="col-sm-8 m-b-xs">
                        ...
                        <a href="/admin/permission/add" class="btn btn-sm btn-default load-content"><i class="fa fa-plus"></i> 添加</a>
                    </div>
            ...
            <section class="scrollable wrapper">
                <section class="panel panel-default">
                    <div class="table-responsive">
                        <table class="table table-striped m-b-sm datagrid" id="permission_listing">
                            <thead>
                            </thead>
                            <tfoot>
                                <tr>
