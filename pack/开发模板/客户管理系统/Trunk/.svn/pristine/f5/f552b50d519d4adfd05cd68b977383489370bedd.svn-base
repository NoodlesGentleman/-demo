...
<!-- 网页内容的js和css样式加载-->
<script src="${STATIC_URL}/js/sysUserRole/sysUserRole.js"></script>
        ...
        <div class="row m-t-sm">
            <div class="col-sm-2 m-b-xs">
                <div class="input-group">
                    <input type="text" style = "width:130px" name="user_login_name" class="input-sm form-control" placeholder="登录名搜索" />
                </div>
            </div>
    ...
    <section class="scrollable wrapper">
        <section class="panel panel-default">
            <div class="table-responsive">
                <table class="table table-striped m-b-none datagrid" id="sysUserRole_listing">
                    <thead>
                    </thead>
                    <tfoot>
                        <tr>
