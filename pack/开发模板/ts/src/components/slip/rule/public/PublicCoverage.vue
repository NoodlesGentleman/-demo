      ...
      <el-row :gutter="20">
        <el-col :span="12">
          <el-form-item label="公共保额名称">
            <el-input v-model="publicAmt.commonName"/>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item>
            <template slot="label">
              <el-checkbox v-model="publicAmt.isWaitDate">
                等待期
              </el-checkbox>
            </template>
            <el-input v-model="publicAmt.waitDate" :disabled="!publicAmt.isWaitDate">
      ...
      <el-row :gutter="20">
        <el-col :span="12">
          <el-form-item label="公共保额代码">
            <el-input v-model="publicAmt.commonCode"/>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-row>
            <el-col :span="16">
              <el-form-item>
                <template slot="label">
                  <el-checkbox v-model="publicAmt.isBearMyselfRatio">
                    承担自费
                  </el-checkbox>
                </template>
                <el-input v-model="publicAmt.bearMyselfRatio" :disabled="!publicAmt.isBearMyselfRatio">
                  <template slot="append">
                    %
                  </template>
                </el-input>
            ...
            <el-col :span="8">
              <el-form-item label="保额" label-width="50px">
                <el-input size="mini" :disabled="!publicAmt.isBearMyselfRatio" v-model="publicAmt.bearMyselfInsuAmt"/>
              </el-form-item>
            </el-col>
          </el-row>
        </el-col>
      ...
      <el-row :gutter="20">
        <el-col :span="12">
          <el-form-item label="保额">
            <el-input v-model="publicAmt.commonquota">
              <template slot="append">
                元
              </template>
            </el-input>
        ...
        <el-col :span="12">
          <el-row>
            <el-col :span="16">
              <el-form-item>
                <template slot="label">
                  <el-checkbox v-model="publicAmt.isBearClassbRatio">
                    承担乙类
                  </el-checkbox>
                </template>
                <el-input v-model="publicAmt.bearClassbRatio" :disabled="!publicAmt.isBearClassbRatio">
                  <template slot="append">
                    %
                  </template>
                </el-input>
            ...
            <el-col :span="8">
              <el-form-item label="保额" label-width="50px">
                <el-input size="mini" :disabled="!publicAmt.isBearClassbRatio" v-model="publicAmt.bearClassbInsuAmt"/>
              </el-form-item>
            </el-col>
          </el-row>
        </el-col>
        ...
        <el-col :span="12">
          <el-form-item label="次免赔">
            <el-row style="font-size: 12px">
              ...
              <el-col :span="5">
                <el-input v-model="publicAmt.lastDeductiblesNext"/>
              </el-col>
              <el-col :span="8">
                次就诊开始,扣除
              </el-col>
              <el-col :span="6">
                <el-input v-model="publicAmt.lastDeductiblesEductionamt"/>
              </el-col>
              <el-col :span="3">
                元/次
              </el-col>
          ...
          <el-row>
            <el-col :span="14">
              <el-form-item label="赔付比例">
                <el-select :value="publicAmt.compensateRatioRule"
                           v-model="publicAmt.compensateRatioRule"
                           placeholder="请选择">
            ...
            <el-col :span="10" v-show="publicAmt.compensateRatioRule === 1">
              <el-form-item label-width="0">
                <el-input v-model="publicAmt.compensateRatio">
                  <template slot="append">%</template>
                </el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-form-item label-width="0" v-show="publicAmt.compensateRatioRule === 2">
            <el-row v-for="(compensate, key) in compensates" :key="key" type="flex" align="center" justify="middle">
              ...
              <el-col :span="2">
                <el-button type="text" v-if="key === 0"
                           @click="publicAmt.insuLimitTypeList.push({type: LimitType.Compensate})">添 加
                </el-button>
                <el-button type="text" v-else @click="publicAmt.insuLimitTypeList.splice(compensate.$$index, 1)">删 除
                </el-button>
              </el-col>
            </el-row>
          </el-form-item>
      ...
      <el-row :gutter="20">
        <el-col :span="12">
          <el-form-item label="备注">
            <el-input type="textarea" v-model="publicAmt.mark"/>
          </el-form-item>
        </el-col>
      </el-row>
    </el-form>
