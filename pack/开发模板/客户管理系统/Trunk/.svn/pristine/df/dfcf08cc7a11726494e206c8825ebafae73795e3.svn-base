...
<script src="${STATIC_URL}/js/sysRoleNav/sysRoleNavEdit.js" type="text/javascript"></script>
		...
		<section class="vbox">
			<header class="header bg-white b-b clearfix">
				...
				<p class="h4" style="float: right;">
					<a href="javascript:;" id="returnPage" class="list" rel="sysRoleNavList">&lt&lt角色菜单管理</a>
				</p>
			</header>
