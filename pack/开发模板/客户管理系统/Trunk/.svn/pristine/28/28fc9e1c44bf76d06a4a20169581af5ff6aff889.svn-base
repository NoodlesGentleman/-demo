...
<div class="modal-dialog" id="modal_edit">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form class="form-horizontal" action="sysNav/update" method="post" id="edit_form">
                    ...
                    <input type="hidden" id="parentIdH" value="${navigation.parentId}"/>
	                    <select name="parentId" id="parentId" class="form-control">
                            <c:forEach items="${navList}" var="v">
                            	<c:if test="${v.navigationId == navigation.parentId }">
                            		<option value="${v.navigationId}" selected="true">${v.title}</option>
                            	</c:if>
                            	<c:if test="${v.navigationId != navigation.parentId }">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-7">
                        <input type="text" class="form-control" name="sortOrder" id="sortOrder" value="${navigation.sortOrder}"/>
                    ...
                    <div class="col-sm-7">
                        <div class="btn-group m-r">
	                        <button class="btn btn-sm btn-default dropdown-toggle" data-toggle="dropdown" id="icon_bg_selected">
	                            <span class="dropdown-label padder ${navigation.iconBg}">
	                                ${navigation.iconBg}
	                            </span> 
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" id="statusH" value="${navigation.status}" />
                    <div class="col-sm-7">
