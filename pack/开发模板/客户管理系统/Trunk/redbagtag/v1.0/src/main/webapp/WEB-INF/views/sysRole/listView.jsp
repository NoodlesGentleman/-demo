    ...
    <header class="header bg-white b-b clearfix">
        <div class="row m-t-sm">
            <div class="col-sm-1 m-b-xs">
                <a href="${STORE_URL}/sysRole/newView" class="btn btn-sm btn-default load-content"><i class="fa fa-plus"></i> 添加</a>
            </div>
    ...
    <section class="scrollable wrapper">
        <section class="panel panel-default">
            <div class="table-responsive">
                <table class="table table-striped m-b-none datagrid" id="sysRole_listing">
                    <thead>
                    </thead>
                    <tfoot>
                        <tr>
